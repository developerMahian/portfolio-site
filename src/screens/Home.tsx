...
const Home = () => {
	...
	return (
		<div className="max-h-[90vh] relative overflow-hidden">
			...
			>
				<div className="text-primary text-base sm:text-[22px] font-bold mb-2">Hey there👋 I am..</div>

				<h1 className="text-[39px] sm:text-6xl md:text-7xl font-extrabold mb-3">Mahian Ahmed</h1>
				...
				<h2 className="text-2xl sm:text-4xl md:text-5xl font-bold opacity-80 mb-8">
					<ReactTypingEffect
						...
						eraseSpeed={30}
						eraseDelay={1500}
						text={[`Vue & React Developer`, `JavaScript Geek`, `Coding Mentor`]}
					/>
				</h2>
