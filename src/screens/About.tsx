      ...
      <div className="flex flex-col lg:flex-row-reverse gap-6 lg:gap-0">
        ...
        <div className="lg:w-3/5">
          <div className="space-y-6 text-justify leading-7 text-base-content/90 font-medium">
            <p>
              I've built products for <Strong>dozens of businesses</Strong>{" "}
              ranging from marketing websites to complex apps with focus on
              fast, elegant and accessible user experiences. I can conjur the
            ...
            <p>
              ...
              <Strong>first impressions matter</Strong>, and good website design
              is the key to capitalizing on them. An excellent site is not
              judged solely on its looks, but on its{" "}
              <Strong>functionality</Strong> and <Strong>usability</Strong> as
              well. My experience as a programmer allows me to come up with{" "}
              <Strong>intelligent solutions</Strong> to technical challenges,
              while at the same time designing sleek and visually appealing
              websites.
            </p>
          </div>
        </div>
